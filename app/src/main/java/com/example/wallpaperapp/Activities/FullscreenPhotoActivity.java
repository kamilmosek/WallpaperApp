...
import com.example.wallpaperapp.Utils.RealmController;
...
public class FullscreenPhotoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intent = getIntent();//there we get photoId
    ...
    private void getPhoto(String id){//get photo from unsplash by photoId
